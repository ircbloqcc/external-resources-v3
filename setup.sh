...
if [[ "$(uname)" == "Darwin" ]]; then
    ...
    LAUNCH_AGENT_PLIST=/Library/LaunchAgents/ircbloq.cc.ircbloqExternalResource.setenv.plist
...
<dict>
    <key>Label</key>
    <string>ircbloq.cc.ircbloqExternalResource.setenv</string>
    <key>ProgramArguments</key>
    <array>
        <string>launchctl</string>
        <string>setenv</string>
        <string>IRCBLOQ</string>
...
EOF
    ...
    PROFILE_FILE="/etc/profile.d/ircbloq-external-resource-setenv.sh"
    ENVIRONMENT_VARIABLE="export IRCBLOQ_EXTERNAL_RESOURCES=\"$INSTALL_DIR\""
