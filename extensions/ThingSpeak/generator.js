...
#include <ThingSpeak.h>`;
       ...
       Blockly.Arduino.setups_.ThingSpeak_init = `Serial.begin(${baudrate});`;
     return '';
  };

    Blockly.Arduino.ThingSpeak_wifi = function (block) {
       // const no = Blockly.Arduino.valueToCode(block, 'no', Blockly.Arduino.ORDER_ATOMIC);
        ...
        Blockly.Arduino.definitions_[`ThingSpeak_wifi`] =
    `const char* ssid = ${tsssid};
const char* password = ${tspswd};
const char* server = "api.thingspeak.com";
WiFiClient client;`;

         Blockly.Arduino.setups_[`ThingSpeak_wifi`] =
